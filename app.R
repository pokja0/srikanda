  ...
  nav_panel(
    ...
    navset_card_underline(
      ...
      nav_panel(
        ...
        h6("Sumber Data: srikandi.arsip.go.id (diakses tanggal 27 Juli 2026)", style="text-align: center;"),
        layout_columns(
          col_widths = 2,
...
server <- function(input, output, session) {
  ...
  output$tanggal_scraping <- renderText({ "27 Juli 2026 - Pukul 09.00 WITA"})
